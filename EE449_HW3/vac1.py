...
class Fuzzy:
    ...
    def __init__(self):
        ...
        self.control_set = np.arange(-0.2,0.21, 0.05)
        ...
        self.control_low = fuzz.trapmf(self.control_set, [-0.2, -0.2, -0.1,0])
        self.control_mid = fuzz.trimf(self.control_set, [-0.1, 0, 0.1])
        self.control_high = fuzz.trapmf(self.control_set,[0, 0.1, 0.2,0.2])        
    ...
    def plot(self):
        ...
        ax1.plot(self.control_set, self.control_low, 'b', linewidth=1.5, label='Low')
        ax1.plot(self.control_set, self.control_mid, 'g', linewidth=1.5, label='Mid')
        ax1.plot(self.control_set, self.control_high, 'r',linewidth=1.5, label='High')
        ax1.set_title('Control Set')
        ax1.legend()
        plt.tight_layout()
